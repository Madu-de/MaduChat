...
export const FR: Language = {
  ...
  options: 'Options',
  public: 'Public',
  onlyAdmins: 'Seulement les administrateurs',
  ...
  send: 'Envoyer',
  youEditedYourReview: 'Vous avez modifié votre avis!',
  youWroteAReview: 'Vous avez écrit un avis!',
  youRemovedYourReview: 'Vous avez supprimé votre avis!',
  stars: 'Étoiles',
  star: 'Étoile',
  overview: 'Aperçu',
  averageStars: 'Étoiles moyennes',
